# NetPulse — Agent Runbook & Operating Directive

## 1. System Overview & Identifiers
* **App Name:** NetPulse
* **Bundle Identifier (iOS):** `com.hushtunnel.netpulse`
* **Package Name (Android):** `com.hushtunnel.netpulse`
* **URL Scheme:** `netpulse://`
* **Monetization Model:** Free download with a single **$4.99 Lifetime Non-Consumable IAP** lifetime unlock
* **Entitlement ID:** `pro`
...
* `https://www.hushtunnel.com/legal/netpulse-privacy`
* `https://www.hushtunnel.com/legal/netpulse-terms`
