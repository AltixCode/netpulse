  ...
  const features = [
    {
      ...
      title: 'Continuous Background Monitor',
      desc: 'Track latency spikes, bufferbloat, and packet drops during gaming or calls.',
    },
    {
      icon: <Network size={20} color="#A855F7" />,
      title: 'Administrative Port Scanner',
      desc: 'Audit open TCP ports (22, 80, 443, 8080) on local devices for security gaps.',
    },
    {
      icon: <FileSpreadsheet size={20} color="#F59E0B" />,
      title: 'ISP Diagnostic Reports',
      desc: 'Export timestamped CSV logs and PDF audit reports to prove connection drops to your ISP.',
    },
    {
      icon: <ShieldCheck size={20} color="#10B981" />,
      title: '100% Ad-Free & Private',
      desc: 'No full-screen video ads. Zero tracking or third-party telemetry.',
    },
  ];
    ...
    <View className="flex-1 bg-slate-950 px-6 py-4">
      ...
      <View className="flex-row items-center justify-between mt-2 mb-4">
        <View className="flex-row items-center">
          ...
          <Text className="text-xl font-extrabold text-white">NetPulse Pro</Text>
        </View>
        <TouchableOpacity
          onPress={() => router.back()}
      ...
      <ScrollView showsVerticalScrollIndicator={false} className="flex-1">
        ...
        <View className="bg-gradient-to-br from-blue-950/80 to-slate-900 border border-blue-900/60 p-5 rounded-2xl mb-6">
          ...
          <Text className="text-slate-400 text-xs mt-2 leading-relaxed">
            Other network tools charge $4.99–$9.99/month and bombard you with full-screen ads.
            NetPulse is a single one-time payment for lifetime access across all your devices.
          </Text>
        </View>
